(function () {
  ...
  var RandomQuoteComponent = Component({
      ...
      //providers: [QuoteService],     // each component has a quoteservice instance
      template: '<p><em>{{quote.line}}</em> - {{quote.author}}</p>'
    })
    .Class({
      // Create service in constructor
      /*
  ...
  var AppModule = NgModule({
      ...
      providers: [QuoteService],   // Share one instance of QuoteService cross whole application.
